...
const Picture = () => {
  return(
    <View>
       <Image source={{ uri: 'https://th.bing.com/th/id/OIP.6RXOic_k7rDeNgcOX0PZJgHaEX?pid=ImgDet&rs=1'}} style ={styles.Picture} />
     </View>
  ) 
};
const BioData = () =>{
  return(
    <View> 
<Text style ={styles.name}> Rodel J. Garcia </Text>
...
const SubjectOfferings = ()=>{
  ...
  <View style = {styles.subjectOfferings}>
    ...
    <View style = {styles.subjectOfferings}>
        <View>
          <Text style = {styles.subjectCode}>IT311</Text>
          </View>
          <View>
